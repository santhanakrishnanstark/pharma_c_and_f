<%-- 
    ...
    Created on : 10 Sep, 2018, 9:43:08 AM
    Author     : settu
--%>
            ...
            <div class="row">
                <div class="col-2">
                    <div class="nav flex-column nav-pills"aria-orientation="vertical">
                        ...
                        <a class="nav-link active"  href="Purchase_Details.jsp" >Purchase Details</a>
                ...
                <div class="col-10">
                    <div class="container">
                       ...
                       <button type="button" class="btn btn-primary m-2 float-right" data-toggle="modal" data-target="#Add_Purchase">
                            Add Purchase
                        </button>
                        <table class="table">
                        ...
                        <!-- Modal Add Purchase Details -->
                <div class="modal fade" id="Add_Purchase" tabindex="-1" role="dialog" aria-labelledby="Add_purchase_details" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="Add_purchase_details">Add Supplier Details</h5>
                      ...
                      <div class="modal-body">
                          <form action="">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="purchase_date" placeholder="Enter the purchase date">
                              </div>
                              <div class="form-group">
                                  <label>Supplier Number</label>
                                  <input class="form-control" name="supplier_number" placeholder="Enter the supplier number">
                              </div>
                              <div class="form-group">
                                  <label>Product Number</label>
                                  <input class="form-control" name="product_number" placeholder="Enter the product number">
                              </div>
                              <div class="form-group">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary">Add Purchase</button>
                        </form>
                      </div>
                    </div>
                  </div>
