<%-- 
    ...
    Created on : 10 Sep, 2018, 9:46:16 AM
    Author     : settu
--%>
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <a class="nav-link "  href="Supplier_Details.jsp" >Supplier Details</a>
                        ...
                        <a class="nav-link active"  href="Stock_Details.jsp" >Stock Details</a>
                ...
                <div class="col-10">
                    <div class="container">
                       ...
                       <button type="button" class="btn btn-primary m-2 float-right" data-toggle="modal" data-target="#Add_Stock">
                            Add Stock
                        </button>
                         <table class="table">
                        ...
                        <!-- Modal Add Stock Details -->
                <div class="modal fade" id="Add_Stock" tabindex="-1" role="dialog" aria-labelledby="Add_stock_details" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="Add_stock_details">Add stock Details</h5>
                      ...
                      <div class="modal-body">
                          <form action="">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="purchase_date" placeholder="Enter the item name">
                              </div>
