<%-- 
    Document   : Billing
    Created on : 10 Sep, 2018, 9:46:48 AM
    Author     : settu
--%>
            ...
            <div class="row">
                <div class="col-2">
                    <div class="nav flex-column nav-pills"aria-orientation="vertical">
                        ...
                        <a class="nav-link active"  href="Billing.jsp" >Billing </a>
                ...
                <div class="col-10">
                    <div class="container">
                       ...
                       <button type="button" class="btn btn-primary m-2 float-right" data-toggle="modal" data-target="#Add_Billing">
                            Billing
                        </button>
                        ...
                        <!-- Modal Add Billing Details -->
                <div class="modal fade" id="Add_Billing" tabindex="-1" role="dialog" aria-labelledby="Add_Billing_details" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="Add_Billing_details">Add Supplier Details</h5>
                      ...
                      <div class="modal-body">
                          <form action="">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="Bill_date" placeholder="Enter the bill date">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="Payment_type" placeholder="Enter the Payment type">
                              </div>
                              <div class="form-group">
                                  <label>Due dater</label>
                                  <input class="form-control" name="due_date" placeholder="Enter the due date">
                              </div>
                              <div class="form-group">
                                  <label>Balance Amount</label>
                                  <input class="form-control" name="Balance_amount" placeholder="Enter the Balance amount">
                              </div>
                      </div>
