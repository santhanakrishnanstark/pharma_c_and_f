...
<html>
    <head>
       ...
       <link rel="stylesheet" href="css/custom_category_details.css">
    </head>
    <body>
               ...
               <div class="col-2 mt-5">
                ...
                <div class="col-2"></div>
                    ...
                    <div class="container mt-5">
                        ...
                        <button type="button" class="btn btn-primary mr-5 mb-3 float-right" data-toggle="modal" data-target="#addcategory">
                            Add Category </button>
                        <table class="table mr-5" id="categorytb">
      ...
      <div class="modal-body">
          <form id="addcategoryfrm">
              <div class="form-group">
                    <label for="addbrand">Category Name :</label>
